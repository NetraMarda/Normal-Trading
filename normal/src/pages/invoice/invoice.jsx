...
import {
  getAllSalesDetailData,
  getSalesDetailData,
} from "../../api/sales/salesDetail.request";
...
const InvoiceForm = ({ data }) => {
  ...
  function handleDeleteSalesData() {
    try {
      ...
      if (isInSalesDetail) {
        alert("Cannot delete the Sales. It is associated with SalesDetail.");
        return;
      }
      ...
      >
        ...
        >
          <CustomIconButton
            ...
            description={"Go Back To Invoice Records"}
          >
            <Link to="/invoiceRecords" style={{ color: "white" }}>
              <ArrowBack />
            </Link>
          </CustomIconButton>
          ...
          <Grid container spacing={3}>
            ...
            <Grid xs={12} sm={3} item>
              <FormControl fullWidth variant="outlined">
                ...
                >
                  <MenuItem value="SD">Sales </MenuItem>
                </Select>
              </FormControl>
            </Grid>
