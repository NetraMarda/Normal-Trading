  ...
  function handleDeletePurchaseDeatailData(id) {
    try{
      ...
      if (isInPurchaseDetail) {
        alert(
          "Cannot delete the PurchaseHead. It is associated with PurchaseDetail."
        );
        return;
      }
      ...
      console.error("Failed to delete PurchaseHead :",error )
    }
  }
      ...
      >
        ...
        >
          <CustomIconButton
            ...
            description={"Go Back To Purchase Records"}
          >
            <Link to="/purchaseRecords" style={{ color: "white" }}>
              <ArrowBack />
            </Link>
          </CustomIconButton>
          ...
          <Grid container spacing={3}>
            ...
            <Grid xs={12} sm={3} item>
              <FormControl fullWidth variant="outlined">
                ...
                >
                  <MenuItem value="PD">Purchase</MenuItem>
                </Select>
              </FormControl>
            </Grid>
